    ...
    <form onSubmit={handleSubmit} className="flex flex-wrap gap-3 items-end">
      <label className="flex flex-col text-sm">
        ...
        <input
          ...
          className="mt-1 min-w-[16rem] rounded-lg border-2 border-[#5bec92]/60 bg-[#1a1f3a] px-4 py-2 text-sm text-slate-200 placeholder:text-slate-500 focus:border-[#5bec92] focus:ring-2 focus:ring-[#5bec92] focus:shadow-lg focus:shadow-[#5bec92]/30 focus:outline-none transition-all"
        />
      </label>
