export default function OverviewPage() {
  return (
    <section className="space-y-6">
      <div className="rounded-xl border-2 border-[#5bec92]/60 bg-[#12172f] p-6 shadow-lg shadow-[#5bec92]/30 hover:border-[#5bec92] hover:shadow-[#5bec92]/50 transition-all">
        ...
        <p className="mt-2 text-base text-slate-300">
          ...
          The console talks directly to the CAVE daemon via the documented <code className="rounded bg-[#1a1f3a] px-2 py-1 text-[#AF75FF] border border-[#5bec92]/40">/api/v1</code>
          endpoints using the bearer token you provide.
        </p>
      </div>
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border-2 border-[#5bec92]/60 bg-[#12172f] p-5 shadow-lg shadow-[#5bec92]/30 hover:border-[#5bec92] hover:shadow-[#5bec92]/50 transition-all">
        ...
        <div className="rounded-xl border-2 border-[#5bec92]/60 bg-[#12172f] p-5 shadow-lg shadow-[#5bec92]/30 hover:border-[#5bec92] hover:shadow-[#5bec92]/50 transition-all md:col-span-2">
