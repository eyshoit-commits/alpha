export default function OverviewPage() {
  return (
    <section className="space-y-6">
      <div className="rounded-xl border-2 border-[#def453]/60 bg-[#12172f] p-6 shadow-lg shadow-[#def453]/30 hover:border-[#def453] hover:shadow-[#def453]/50 transition-all">
        ...
        <p className="mt-2 text-base text-slate-300">
          ...
          The console talks directly to the CAVE daemon via the documented <code className="rounded bg-[#1a1f3a] px-2 py-1 text-[#AF75FF] border border-[#def453]/40">/api/v1</code>
          endpoints using the bearer token you provide.
        </p>
      </div>
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border-2 border-[#def453]/60 bg-[#12172f] p-5 shadow-lg shadow-[#def453]/30 hover:border-[#def453] hover:shadow-[#def453]/50 transition-all">
        ...
        <div className="rounded-xl border-2 border-[#def453]/60 bg-[#12172f] p-5 shadow-lg shadow-[#def453]/30 hover:border-[#def453] hover:shadow-[#def453]/50 transition-all md:col-span-2">
