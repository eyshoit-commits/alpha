...
- **Aktionen**
  ...
  > Status 2025-10-18: OverlayFS, cgroups v2 und Seccomp-Allowlist laufen im Prozess-Runtime inkl. Linux-Tests (`crates/cave-kernel/src/lib.rs:663-1059`, `crates/cave-kernel/src/isolation.rs:233-420`, `crates/cave-kernel/tests/isolation_linux.rs:1-171`). Bubblewrap-Profile bleiben offen.
